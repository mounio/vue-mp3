...
<script>
  ...
  export default {
    ...
    data () {
      return {
        playlist: [
          {title: "SAINt_JHN_Roses_Imanbek_Remix", artist: "Imanbek", howl: null, display: true},
          {title: "Dennis_Lloyd_NEVERMIND", artist: "Dennis Lloyd", howl: null, display: true},
          {title: "Hamza_Netflix", artist: "Hamza", howl: null, display: true},
          {title: "Hamza_Nobu", artist: "Hamza", howl: null, display: true},
          {title: "Hamza_Henny_Pop", artist: "Hamza", howl: null, display: true}
        ],
        selectedTrack: null,
        index: 0,
        playing: false,
